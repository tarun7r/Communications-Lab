...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(60, firdes.low_pass(
        	5, 32000, 10000, 100, firdes.WIN_HAMMING, 6.76))
        self.hilbert_fc_0 = filter.hilbert_fc(600, firdes.WIN_HAMMING, 6.76)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 500000, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 0.5, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_float_to_complex_0, 0))
